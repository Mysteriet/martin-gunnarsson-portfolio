...
export default function Contact() {
  return (
    <div name="contact" className="w-full h-screen bg-primary-color flex justify-center items-center p-4">
      <form method="POST" action="" className="flex flex-col max-w-[600px] w-full">
        ...
        <button className="text-white border-2 hover:bg-accent-color hover:border-accent-color px-4 py-3 my-8 mx-auto flex items-center">Let's Collaborate</button>
      </form>
    </div>
  )
}
